...
export function mapClaim(row: Row): Claim {
  return {
    ...
    verificationQuery: row.verification_query ? String(row.verification_query) : null,
    verifiabilityReason: row.verifiability_reason ? String(row.verifiability_reason) : null,
    verificationSources: row.verification_sources ? String(row.verification_sources) : null,
    verificationConfidence: row.verification_confidence ? String(row.verification_confidence) : null,
